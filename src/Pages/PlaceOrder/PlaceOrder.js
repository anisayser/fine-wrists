...
const PlaceOrder = () => {
    ...
    /*  console.log(orderDate)
        ...
        console.log(orderDate.toLocaleTimeString())
        console.log(orderDate.toUTCString())
        console.log(orderDate.getDate())
        console.log(orderDate.getTimezoneOffset())
        console.log(orderDate.getUTCDate())
        console.log(orderDate.getUTCFullYear()) */

    // TOTAL COST
    let subTotal = 0;
    for (const product of userCart) {
        subTotal += parseFloat(product.cartProduct.price);
    }
                    ...
                    <form onSubmit={handlePlaceOrder}>
                        <Grid container spacing={4}>
                            <Grid item xs={12} md={6}>
                                <Box className=''>
                                    <Typography variant='h4' color='muted.main' className='text-left pb-2'>Billing Details</Typography>
                                    <Divider />

                                    <Box className='flex flex-col space-y-5 py-5'>
                                        <TextField id="name" name='name' disabled label="Name" defaultValue={user?.displayName} variant="outlined" />

                                        <TextField id="company" name='company' onBlur={handleOnBlur} label="Company" variant="outlined" />
                                        ...
                                        <Autocomplete
                                            ...
                                            renderInput={(params) => (
                                                <TextField name='country' onBlur={handleOnBlur}
                                                    {...params}
                                        ...
                                        <TextField id="streetAddress" name='street' onBlur={handleOnBlur} label="Street Address" variant="outlined" />
                                        <TextField id="apartment" name='apartment' onBlur={handleOnBlur} label="Apartment" variant="outlined" />
                                        <TextField id="city" name='city' onBlur={handleOnBlur} label="City/Town" required variant="outlined" />
                                        <Autocomplete
                                            disablePortal
                                            id="combo-box-demo"
                                            options={top100Films}
                                            sx={{ width: 300 }}
                                            renderInput={(params) => <TextField name='district' onBlur={handleOnBlur} {...params} label="District" required />}
                                        />
                                        <TextField id="zip" name='zipcode' onBlur={handleOnBlur} label="Zip Code" required variant="outlined" />
                                        <TextField id="phone" name='phone' onBlur={handleOnBlur} label="Phone" required variant="outlined" />
                                        <TextField id="email" name='email' disabled label="Email" defaultValue={user?.email} type='email' required variant="outlined" />
                                        <TextareaAutosize name='ordernotes' onBlur={handleOnBlur} className='bg-[#2f2f2f] p-3 rounded' placeholder='Order Notes' />
                            ...
                            <Grid item xs={12} md={6}>
                                <Box>
                                    <Typography variant='h4' color='muted.main'>Your Order</Typography>
                                    ...
                                    <Box className='text-left'>
                                        <FormControl>
                                            <Typography variant='h6' color='muted.main'>Please Choose a payment method.</Typography>
                                            <RadioGroup
                                            ...
                                            >
                                                <FormControlLabel className='text-[#abafb3]' value="cash" control={<Radio />} label="Cash on Delivery" />
                                                <FormControlLabel className='text-[#abafb3]' value="free" control={<Radio />} label="Free" />
                                                <FormControlLabel className='text-[#abafb3]' value="other" control={<Radio />} label="Other" />
                                            </RadioGroup>
                                        </FormControl>

                                        <Divider />

                                        <Box className='flex items-center text-[#abafb3]'>
                                            <FormControlLabel control={<Checkbox defaultChecked />} label="I have read and agree to the website" />
                                            <Typography variant='subtitle1'>Terms & Conditions</Typography>
                                        </Box>

                                        <MyButton type='submit' className='mt-5'>Place Order</MyButton>
